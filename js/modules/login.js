...
if (currentUser) {
  ...
  headerLogout.style.display = "flex"; //задаем свойство flex

  //отрисовка для автризованного пользователя
  headerAccount.innerHTML = '<img src="./img/profile.png">';
  ...
  headerLogout.style.display = "none"; //задаем свойство none
